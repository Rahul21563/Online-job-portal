...
<?php
	...
	if (!validatePasswordComplexity($_POST['txtPassword'])) {
		echo '<script type="text/javascript">alert("Password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, one number, and one special character.");window.location=\'JobSeekerReg.php\';</script>';
		exit;
	}
